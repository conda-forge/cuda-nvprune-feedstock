...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/cuda-nvprune-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/cuda-nvprune-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add cuda-nvprune
# for installing globally
pixi global install cuda-nvprune
```
...
It is possible to list all of the versions of `cuda-nvprune` available on your platform:
...
```
pixi search cuda-nvprune --channel conda-forge
```
